...
class OlmoEarthSample(NamedTuple):
    ...
    rgb: ArrayTensor | None = None  # [B, H, W, T, len(RGB_bands)]
    sar: ArrayTensor | None = None  # [B, H, W, T, len(SAR_bands)]
    landcover_1m: ArrayTensor | None = None
    landcover_30m: ArrayTensor | None = None
    lt1: ArrayTensor | None = None
...
class MaskedOlmoEarthSample(NamedTuple):
    ...
    rgb_mask: Tensor | None = None
    sar: Tensor | None = None
    sar_mask: Tensor | None = None
    landcover_1m: Tensor | None = None
    landcover_1m_mask: Tensor | None = None
    landcover_30m: Tensor | None = None
    landcover_30m_mask: Tensor | None = None
    lt1: Tensor | None = None
    lt1_mask: Tensor | None = None
