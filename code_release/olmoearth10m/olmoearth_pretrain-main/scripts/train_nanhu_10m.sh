...
torchrun --nnodes=$WORLD_SIZE --node_rank=$RANK  --master_addr=$MASTER_ADDR --nproc_per_node=$TQ_GPU_NUM --master_port $MASTER_PORT scripts/official/nano.py train ${TRAIN_NAME} local \
