...
TRAIN_NAME="nanhu_10m_base_ema_20260609"
...
mkdir -p /mnt/si000523ygkv/00-model/olmoearth/logs
...
--dataset.h5py_dir=/mnt/si000523ygkv/EO_Pretrian_Data_zhejiang_olmoearth_fmt/landcover_1m_landcover_30m_landsat_lt1_rgb_sar_sentinel1_sentinel2_l2a_srtm_worldcereal_worldcover/61512 \
...
--common.save_folder="/mnt/si000523ygkv/00-model/olmoearth/logs/${TRAIN_NAME}"